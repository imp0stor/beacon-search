import { ConsensusResult, ConsensusSegment, SubtitleSegment, TVSubtitleVariant } from './types';
import { estimateSegmentDuration, jaccardSimilarity } from './subtitles';

interface VariantScore {
  variant: TVSubtitleVariant;
...
function calculateVariantScore(variant: TVSubtitleVariant, segments: SubtitleSegment[], maxDuration: number): VariantScore {
